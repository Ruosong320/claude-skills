...
**本节是上述流程的例外条款：与正文规则冲突时——包括「禁止行为」清单、核心原则 1「不接受纯理论或臆测方案」、核心原则 2「证据驱动」的绝对要求、第 2 步的先验/项目内/检索三档优先级顺序——以本表为准——但仅在该表某行的一线修复与正文规则确实冲突时生效；没有任何一行与之冲突的正文规则，照常保留全文效力。同一情形命中多行时，取一线修复最保守的那一行——停下、询问、不写入，一律优先于继续推进。但每一处例外都必须在方案首段显式标出，不得静默降级。**
