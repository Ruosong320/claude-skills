...
**本节是上述流程的例外条款：与正文规则冲突时——包括「禁止行为」清单、核心原则 1「不接受纯理论或臆测方案」、核心原则 2「证据驱动」的绝对要求、第 2 步的先验/项目内/检索三档优先级顺序——以本表为准，其余未列出的规则同理。同一情形命中多行时，取更靠上的那一行。但每一处例外都必须在方案首段显式标出，不得静默降级。**
